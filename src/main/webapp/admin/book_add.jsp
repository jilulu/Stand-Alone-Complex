...
<div>
    ...
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/admin/book/add">
        <div class="form-group">
            <label for="inputTitle" class="col-sm-2 control-label">*Title</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputTitle" name="inputTitle" placeholder="Pete the Cat: Big Easter Adventure">
            </div>
        </div>
        <div class="form-group">
            <label for="inputAuthor" class="col-sm-2 control-label">Author</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputAuthor" name="inputAuthor" placeholder="James Dean, Kimberly Dean">
            </div>
        </div>
        <div class="form-group">
            <label for="inputPublisher" class="col-sm-2 control-label">Publisher</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputPublisher" name="inputPublisher" placeholder="Harper Collins, 2014">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <textarea class="form-control" rows="5" id="inputSummary" name="inputSummary" placeholder="The book summary..."></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="inputISBN" class="col-sm-2 control-label">ISBN</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputISBN" name="inputISBN" placeholder="0062198688, 9780062198686">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="url" class="form-control" id="inputCover" name="inputCover" placeholder="www.abc.com">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="number" class="form-control" id="inputPrice" name="inputPrice" placeholder="20">
            </div>
        </div>
